    ...
    public class JobDataManagerTest
    {
        ...
        public void AddJobTest()
        {
            ...
            Job job = new Job()
            {
                ...
                ,
                GroupName = "EmailNotifications"
                ,
                Description = "Email will go out. It is scheduled to run every Friday at 5 PM."
                ,
                AssemblyName = "SaiVision.Platform.Common",
                ClassName = "SaiVision.Platform.Common.ValidationResultEmailJob"
                ,
                IsActive = true
                ,
                TempBigInt = 123
