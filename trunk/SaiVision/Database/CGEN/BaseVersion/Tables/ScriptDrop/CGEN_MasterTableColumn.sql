...
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_CGEN_MasterTableColumn_IsTruncatePrefix]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[CGEN_MasterTableColumn] DROP CONSTRAINT [DF_CGEN_MasterTableColumn_IsTruncatePrefix]
END
